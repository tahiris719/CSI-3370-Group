...
public class SpellBookResourceIntTest {
    ...
    private static final Integer DEFAULT_MAX_SPELLS = 1;
    private static final Integer UPDATED_MAX_SPELLS = 2;

    private static final String DEFAULT_SPELLS = "AAAAAAAAAA";
    private static final String UPDATED_SPELLS = "BBBBBBBBBB";
    ...
    public void createSpellBook() throws Exception {
        ...
        assertThat(testSpellBook.getMaxSpells()).isEqualTo(DEFAULT_MAX_SPELLS);
        assertThat(testSpellBook.getSpells()).isEqualTo(DEFAULT_SPELLS);
    ...
    public void getAllSpellBooks() throws Exception {
        ...
        restSpellBookMockMvc.perform(get("/api/spell-books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].maxSpells").value(hasItem(DEFAULT_MAX_SPELLS)))
            .andExpect(jsonPath("$.[*].spells").value(hasItem(DEFAULT_SPELLS.toString())));
    }
    ...
    public void getSpellBook() throws Exception {
        ...
        restSpellBookMockMvc.perform(get("/api/spell-books/{id}", spellBook.getId()))
            ...
            .andExpect(jsonPath("$.maxSpells").value(DEFAULT_MAX_SPELLS))
            .andExpect(jsonPath("$.spells").value(DEFAULT_SPELLS.toString()));
    }
    ...
    public void updateSpellBook() throws Exception {
        ...
        SpellBook testSpellBook = spellBookList.get(spellBookList.size() - 1);
        assertThat(testSpellBook.getMaxSpells()).isEqualTo(UPDATED_MAX_SPELLS);
        assertThat(testSpellBook.getSpells()).isEqualTo(UPDATED_SPELLS);
    ...
    public void searchSpellBook() throws Exception {
        ...
        restSpellBookMockMvc.perform(get("/api/_search/spell-books?query=id:" + spellBook.getId()))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(spellBook.getId().intValue())))
            .andExpect(jsonPath("$.[*].maxSpells").value(hasItem(DEFAULT_MAX_SPELLS)))
            .andExpect(jsonPath("$.[*].spells").value(hasItem(DEFAULT_SPELLS)));
    }
